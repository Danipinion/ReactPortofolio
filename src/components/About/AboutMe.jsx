...
function AboutMe() {
  return (
    <>
      ...
      <h1 className="font-semibold text-slate-400  text-xl mt-7">
        What I'm Doing
      </h1>
      <div className="doings flex gap-2 mt-2">
        <div className="doing w-2/4 flex items-center bg-cyan-600 rounded-md p-5">
      ...
      <div className="skills flex gap-10 text-center mt-3">
        <div className="skill">
